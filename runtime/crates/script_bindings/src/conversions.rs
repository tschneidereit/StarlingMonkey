...
use js::glue::{
    GetProxyHandlerExtra, GetProxyReservedSlot, IsProxyHandlerFamily,
    JS_GetReservedSlot,
};
use js::jsapi::{
    Heap, JSContext, JSObject,
};
use js::jsval::{ObjectValue, UndefinedValue};
use js::rust::{
    HandleValue, MutableHandleValue, get_object_class, is_dom_class,
