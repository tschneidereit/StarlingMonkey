...
wrap!(raw: pub fn CrossCompartmentWrapper_getOwnPropertyDescriptor(this: *mut ::std::os::raw::c_void, cx: *mut raw::JSContext, wrapper: raw::JS::HandleObject, id: raw::JS::HandleId, desc: u32) -> bool);
...
wrap!(raw: pub fn OpaqueCrossCompartmentWrapper_getOwnPropertyDescriptor(this: *mut ::std::os::raw::c_void, cx: *mut raw::JSContext, wrapper: raw::JS::HandleObject, id: raw::JS::HandleId, desc: u32) -> bool);
...
wrap!(raw: pub fn GetRealmFunctionPrototypeHandle(cx: *mut raw::JSContext) -> raw::JS::Handle<*mut raw::JSObject>);
...
wrap!(raw: pub fn Evaluate1(cx: *mut raw::JSContext, envChain: *const raw::JS::EnvironmentChain, options: *const raw::JS::ReadOnlyCompileOptions, srcBuf: *mut raw::JS::SourceText<u16>, rval: raw::JS::MutableHandle<raw::JS::Value>) -> bool);
...
wrap!(raw: pub fn GetRequestedModuleType(cx: *mut raw::JSContext, moduleRecord: raw::JS::Handle<*mut raw::JSObject>, index: u32) -> raw::JS::ModuleType);
wrap!(raw: pub fn GetModuleScript(moduleRecord: raw::JS::Handle<*mut raw::JSObject>) -> *mut raw::JSScript);
wrap!(raw: pub fn CreateModuleRequest(cx: *mut raw::JSContext, specifierArg: raw::JS::Handle<*mut raw::JSString>, moduleType: raw::JS::ModuleType) -> *mut raw::JSObject);
...
wrap!(raw: pub fn GetModuleRequestType(cx: *mut raw::JSContext, moduleRequestArg: raw::JS::Handle<*mut raw::JSObject>) -> raw::JS::ModuleType);
...
wrap!(raw: pub fn CaptureCurrentStack(cx: *mut raw::JSContext, stackp: raw::JS::MutableHandleObject, capture: *mut raw::JS::StackCapture, startAfter: raw::JS::HandleObject) -> bool);
...
wrap!(raw: pub fn JS_ExecuteScript2(cx: *mut raw::JSContext, envChain: *const raw::JS::EnvironmentChain, script: raw::JS::Handle<*mut raw::JSScript>, rval: raw::JS::MutableHandle<raw::JS::Value>) -> bool);
wrap!(raw: pub fn JS_ExecuteScript3(cx: *mut raw::JSContext, envChain: *const raw::JS::EnvironmentChain, script: raw::JS::Handle<*mut raw::JSScript>) -> bool);
...
wrap!(raw: pub fn JS_StringifyWithLengthHint(cx: *mut raw::JSContext, value: raw::JS::MutableHandle<raw::JS::Value>, replacer: raw::JS::Handle<*mut raw::JSObject>, space: raw::JS::Handle<raw::JS::Value>, callback: raw::JSONWriteCallback, data: *mut ::std::os::raw::c_void, lengthHint: usize) -> bool);
...
wrap!(raw: pub fn JS_Enumerate(cx: *mut raw::JSContext, obj: raw::JS::Handle<*mut raw::JSObject>, props: raw::JS::MutableHandle<raw::JS::IdVector>) -> bool);
