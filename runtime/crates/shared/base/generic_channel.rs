...
enum GenericSenderVariants<T: Serialize> {
    ...
    Crossbeam(crossbeam_channel::Sender<Result<T, bincode::Error>>),
}
        ...
        A: serde::de::EnumAccess<'de>,
    {
        ...
        match variant_name {
            ...
            GenericSenderVariantNames::Crossbeam => {
                ...
                let ptr = addr as *mut crossbeam_channel::Sender<Result<T, bincode::Error>>;
...
pub type RoutedReceiver<T> = crossbeam_channel::Receiver<Result<T, bincode::Error>>;
...
pub type RoutedReceiverReceiveResult<T> =
    Result<Result<T, bincode::Error>, crossbeam_channel::RecvError>;
...
impl<T> fmt::Debug for GenericReceiver<T>
where
    T: for<'de> Deserialize<'de> + Serialize,
{
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
...
mod single_process_channel_tests {
    ...
    use crate::generic_channel::new_generic_channel_crossbeam;
    // use crate::generic_channel::new_generic_channel_ipc;
