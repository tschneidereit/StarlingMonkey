...
pub type MsgCallback<T> = dyn FnMut(Result<T, bincode::Error>) + Send;
    ...
    T: for<'de> Deserialize<'de> + Serialize + Send + 'static,
{
    ...
    pub fn new<F: FnMut(Result<T, bincode::Error>) + Send + 'static>(
        callback: F,
...
mod single_process_callback_test {
    ...
    fn generic_callback() {
        ...
        let callback = move |msg: Result<usize, bincode::Error>| {
