...
namespace content_debugger {
   ...
   *
   * @param cx the JSContext to use for the debugger
   ...
   */
  void maybe_init_debugger(JSContext *cx, bool content_already_initialized);
   ...
   */
  optional<std::string_view> replacement_script_path();
} // namespace content_debugger
