...
function(integration_tests)
    ...
    add_custom_command(
            ...
            COMMAND ${CMAKE_COMMAND} -E env "WASM_TOOLS=${WASM_TOOLS_DIR}/wasm-tools" env "WASMTIME=${WASMTIME}" env "PREOPEN_DIR=${CMAKE_SOURCE_DIR}/tests" ${RUNTIME_DIR}/componentize.sh ${TESTS_DIR}/test-server.js test-server.wasm
            DEPENDS ${DEPS}
            VERBATIM
    )
